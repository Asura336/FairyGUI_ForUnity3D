...
namespace FairyGUI
{
    ...
    public class StraightLineMesh : IMeshFactory
    {
        ...
        public void OnPopulateMesh(VertexBuffer vb)
        {
            ...
            widthVector *= lineWidth * 0.5f;
            vb.AddVert(origin - widthVector, color, v0);
            vb.AddVert(origin + widthVector, color, v1);
            vb.AddVert(end + widthVector, color, v2);
            vb.AddVert(end - widthVector, color, v3);
