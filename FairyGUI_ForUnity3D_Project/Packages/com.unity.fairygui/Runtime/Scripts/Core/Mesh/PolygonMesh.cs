...
namespace FairyGUI
{
    ...
    public class PolygonMesh : IMeshFactory, IHitTest
    {
        ...
        static readonly List<int> sRestIndices = new List<int>(64);

        public PolygonMesh()
        {
            points = new List<Vector2>(16);
            texcoords = new List<Vector2>(16);
        }
        ...
        void DrawOutline(VertexBuffer vb)
        {
            ...
            float lineWidth_half = lineWidth * 0.5f;
            for (int i = 0; i < numVertices; i++)
            {
                ...
                widthVector *= lineWidth_half;
                vb.AddVert(p0 - widthVector, lineColor);
                vb.AddVert(p0 + widthVector, lineColor);
                vb.AddVert(p1 - widthVector, lineColor);
                vb.AddVert(p1 + widthVector, lineColor);
        ...
        static bool IsPointInTriangle(ref Vector2 p, ref Vector2 a, ref Vector2 b, ref Vector2 c)
        {
            // From Starling
