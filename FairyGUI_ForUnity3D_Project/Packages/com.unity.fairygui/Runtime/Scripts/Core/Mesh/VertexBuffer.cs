...
namespace FairyGUI
{
    ...
    public sealed class VertexBuffer
    {
        ...
        public static readonly Vector2[] NormalizedUV = new Vector2[] {
            new Vector2(0, 0), new Vector2(0, 1), new Vector2(1, 1), new Vector2(1, 0) };

        public static readonly Vector2[] NormalizedPosition = new Vector2[] {
        ...
        {
            const int vertCapacity = 32;
            const int indexCapacity = vertCapacity * 2;

            vertices = new List<Vector3>(vertCapacity);
            colors = new List<Color32>(vertCapacity);
            uvs = new List<Vector2>(vertCapacity);
            uvs2 = new List<Vector2>(vertCapacity);
        ...
        static readonly List<Vector4> helperV4List = new List<Vector4>(4) { Vector4.zero, Vector4.zero, Vector4.zero, Vector4.zero };
        ...
        static readonly float[] STROKE_OFFSET = new float[]
        {
             -1, 0, 1, 0,
            0, -1, 0, 1,
            -1, -1, 1, -1,
