...
namespace FairyGUI
{
    ...
    /// 
    /// </summary>
    public partial class Shape : DisplayObject
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <param name="fillColor"></param>
        public void DrawPolygon(IEnumerable<Vector2> points, Color fillColor)
        {
        ...
        /// <param name="points"></param>
        /// <param name="colors"></param>
        public void DrawPolygon(IEnumerable<Vector2> points, Color32[] colors)
        {
            PolygonMesh mesh = graphics.GetMeshFactory<PolygonMesh>();
            mesh.points.Clear();
            mesh.points.AddRange(points);
        ...
        /// <param name="lineSize"></param>
        /// <param name="lineColor"></param>
        public void DrawPolygon(IEnumerable<Vector2> points, Color fillColor, float lineSize, Color lineColor)
        {
            PolygonMesh mesh = graphics.GetMeshFactory<PolygonMesh>();
            mesh.points.Clear();
            mesh.points.AddRange(points);
